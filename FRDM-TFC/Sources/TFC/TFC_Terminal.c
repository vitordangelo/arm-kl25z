...
TerminalCallbackRecord MyTerminalCallbackRecords[] = { { "help",
		TerminalCmd_Help, "Lists available commands" }, { "L",
		TerminalCmd_GetLineScan, "Displays linescan camera data" }, { "S",
		TerminalCmd_S, "Commands the servos to a position" }, { "H",
		TerminalCmd_H, "Commands the H-Bridges" }, { "E", TerminalCmd_E,
		"Enables the H-Bridges" }, { "D", TerminalCmd_D,
		"Disables the H-Bridges" }, };
